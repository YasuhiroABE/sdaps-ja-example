...
\begin{questionnaire}[noinfo]
  ...
  \end{choicegroup}
  \begin{optionquestion}[cols=3,singlechoice]{optionquestion test}
    \choiceitem{choiceitem}
    \choicemulticolitem{2}{choicemulticolitem test}
  \end{optionquestion}
  \begin{optiongroup}[singlechoice]{optiongroup test}
    \choice{choice1}
    \choice{choice2}
    \question{question1}
    \question{question2}
  ...
  \begin{choicequestion}[cols=3,multichoice] {choicequestion test}
    \choiceitem{choiceitem test}
    \choicemulticolitem{2}{choicemulticolitem test}
    \choiceitemtext{0.5cm}{3}{choiceitemtext test}
  \end{choicequestion}
  \begin{choicegroup}[multichoice] {choicegroup test}
    ...
    \question{question2}
  \end{choicegroup}
  \begin{optionquestion}[cols=3,multichoice]{optionquestion test}
    \choiceitem{choiceitem}
    \choicemulticolitem{2}{choicemulticolitem test}
  \end{optionquestion}
  \begin{optiongroup}[multichoice]{optiongroup test}
    \choice{choice1}
    \choice{choice2}
    \question{question1}
    \question{question2}
